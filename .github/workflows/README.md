...
|-----------|-------------|--------------|----------|
| `THUNDER_PACK_URL` | URL to download the Thunder pack | `https://github.com/thunder-id/thunderid/releases/download/v1.0.0-alpha/thunderid-1.0.0-alpha-linux-x64.zip` | Yes |
