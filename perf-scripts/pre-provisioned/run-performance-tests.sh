...
function before_execute_test_scenario() {
    ...
    # Skipping Cleaning DBs as that is not required in Thunder at present
}

function after_execute_test_scenario() {

    echo ""
    # Skipping getting DB metrics for now as DB scripts for postgres have to be developed
}
