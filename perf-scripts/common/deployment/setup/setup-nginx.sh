...
sudo cp resources/thunder.conf /etc/nginx/conf.d/
...
sudo sed -i 's$server xxx.xxx.xxx.1:8090$server '$wso2_thunder_1_ip':8090$g' /etc/nginx/conf.d/thunder.conf || echo "error 1"
